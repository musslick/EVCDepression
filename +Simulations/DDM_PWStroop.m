...
%                 this.results.drift.Ntr(subj) = this.results.driftControl.Ntr(subj) + this.results.driftAutomatic.Ntr(subj);
            ...
            toRemoveFromInterference = (this.results.analysis.congruencyCondition == (1+1)); % remove congruency conditions
            toRemoveFromFacilitation = (this.results.analysis.congruencyCondition == (2+1)); % remove incongruency conditions
            
            this.results.analysisInterference.ERData = this.results.analysis.ERData;
            this.results.analysisInterference.RTData = this.results.analysis.RTData;
            this.results.analysisInterference.subject = this.results.analysis.subject;
            this.results.analysisInterference.rewardCondition = this.results.analysis.rewardCondition;
            this.results.analysisInterference.congruencyCondition = this.results.analysis.congruencyCondition;
            
            this.results.analysisFacilitation.ERData = this.results.analysis.ERData;
            this.results.analysisFacilitation.RTData = this.results.analysis.RTData;
            this.results.analysisFacilitation.subject = this.results.analysis.subject;
            this.results.analysisFacilitation.rewardCondition = this.results.analysis.rewardCondition;
            this.results.analysisFacilitation.congruencyCondition = this.results.analysis.congruencyCondition;
            
            this.results.analysisInterference.ERData(toRemoveFromInterference) = [];
            this.results.analysisInterference.RTData(toRemoveFromInterference) = [];
            this.results.analysisInterference.subject(toRemoveFromInterference) = [];
            this.results.analysisInterference.rewardCondition(toRemoveFromInterference) = [];
            this.results.analysisInterference.congruencyCondition(toRemoveFromInterference) = [];
            
            this.results.analysisInterference.congruencyCondition(this.results.analysisInterference.congruencyCondition == (2+1)) = 2;  % make sure factor levels are 1 and 2
            
            this.results.analysisFacilitation.ERData(toRemoveFromFacilitation) = [];
            this.results.analysisFacilitation.RTData(toRemoveFromFacilitation) = [];
            this.results.analysisFacilitation.subject(toRemoveFromFacilitation) = [];
            this.results.analysisFacilitation.rewardCondition(toRemoveFromFacilitation) = [];
            this.results.analysisFacilitation.congruencyCondition(toRemoveFromFacilitation) = [];
            
            this.results.ANOVA_ER.interferenceEffect.stats = rm_anova2(this.results.analysisInterference.ERData, ...
                                                                                this.results.analysisInterference.subject, ...
                                                                                this.results.analysisInterference.rewardCondition, ...
                                                                                this.results.analysisInterference.congruencyCondition, ...
                                                                                {'reward', 'congruency'});
                                                                            
            this.results.ANOVA_RT.interferenceEffect.stats = rm_anova2(this.results.analysisInterference.RTData, ...
                                                                                this.results.analysisInterference.subject, ...
                                                                                this.results.analysisInterference.rewardCondition, ...
                                                                                this.results.analysisInterference.congruencyCondition, ...
                                                                                {'reward', 'congruency'});
            ...
            this.results.ANOVA_ER.facilitationEffect.stats = rm_anova2(this.results.analysisFacilitation.ERData, ...
                                                                                this.results.analysisFacilitation.subject, ...
                                                                                this.results.analysisFacilitation.rewardCondition, ...
                                                                                this.results.analysisFacilitation.congruencyCondition, ...
                                                                                {'reward', 'congruency'});
                                                                            
            this.results.ANOVA_RT.facilitationEffect.stats = rm_anova2(this.results.analysisFacilitation.RTData, ...
                                                                                this.results.analysisFacilitation.subject, ...
                                                                                this.results.analysisFacilitation.rewardCondition, ...
                                                                                this.results.analysisFacilitation.congruencyCondition, ...
                                                                                {'reward', 'congruency'});
        ...
        function dispResults(this)
            ...
            disp('---');
            disp(['RT ANOVA (2x3), reward, F(' num2str(this.results.ANOVA_RT.main.stats{2,3}) ... % df for interaction = df(condition 1) * df(condition 2)
            ...
            disp(['RT ANOVA (2x3), congruency, F(' num2str(this.results.ANOVA_RT.main.stats{3,3}) ... 
            ...
            disp(['RT ANOVA (2x3), reward x congruency, F(' num2str(this.results.ANOVA_RT.main.stats{4,3}) ... 
            ...
            disp(['ER ANOVA (2x3), reward, F(' num2str(this.results.ANOVA_ER.main.stats{2,3}) ... 
            ...
            disp(['ER ANOVA (2x3), congruency, F(' num2str(this.results.ANOVA_ER.main.stats{3,3}) ... 
            ...
            disp(['ER ANOVA (2x3), reward x congruency, F(' num2str(this.results.ANOVA_ER.main.stats{4,3}) ... 
            ...
            disp(['RT ANOVA (2x2, Interference Effect), reward, F(' num2str(this.results.ANOVA_RT.interferenceEffect.stats{2,3}) ... % df for interaction = df(condition 1) * df(condition 2)
                                                              ', ' num2str(this.results.ANOVA_RT.interferenceEffect.stats{5,3}) ...    
                                                              ') = ' num2str(this.results.ANOVA_RT.interferenceEffect.stats{2,end-1}) ...
                                                              ', p = ' num2str(this.results.ANOVA_RT.interferenceEffect.stats{2,end})]);
                                                          
            disp(['RT ANOVA (2x2, Interference Effect), congruency, F(' num2str(this.results.ANOVA_RT.interferenceEffect.stats{3,3}) ... 
                                                              ', ' num2str(this.results.ANOVA_RT.interferenceEffect.stats{6,3}) ...    
                                                              ') = ' num2str(this.results.ANOVA_RT.interferenceEffect.stats{3,end-1}) ...
                                                              ', p = ' num2str(this.results.ANOVA_RT.interferenceEffect.stats{3,end})]);
                                                          
            disp(['RT ANOVA (2x2, Interference Effect), reward x congruency, F(' num2str(this.results.ANOVA_RT.interferenceEffect.stats{4,3}) ... 
                                                              ', ' num2str(this.results.ANOVA_RT.interferenceEffect.stats{7,3}) ...    
                                                              ') = ' num2str(this.results.ANOVA_RT.interferenceEffect.stats{4,end-1}) ...
                                                              ', p = ' num2str(this.results.ANOVA_RT.interferenceEffect.stats{4,end})]);
                                                          
            disp(['ER ANOVA (2x2, Interference Effect), reward, F(' num2str(this.results.ANOVA_ER.interferenceEffect.stats{2,3}) ... 
                                                              ', ' num2str(this.results.ANOVA_ER.interferenceEffect.stats{5,3}) ...    
                                                              ') = ' num2str(this.results.ANOVA_ER.interferenceEffect.stats{2,end-1}) ...
                                                              ', p = ' num2str(this.results.ANOVA_ER.interferenceEffect.stats{2,end})]);
                                                          
            disp(['ER ANOVA (2x2, Interference Effect), congruency, F(' num2str(this.results.ANOVA_ER.interferenceEffect.stats{3,3}) ... 
                                                              ', ' num2str(this.results.ANOVA_ER.interferenceEffect.stats{6,3}) ...    
                                                              ') = ' num2str(this.results.ANOVA_ER.interferenceEffect.stats{3,end-1}) ...
                                                              ', p = ' num2str(this.results.ANOVA_ER.interferenceEffect.stats{3,end})]);
                                                          
            disp(['ER ANOVA (2x2, Interference Effect), reward x congruency, F(' num2str(this.results.ANOVA_ER.interferenceEffect.stats{4,3}) ... 
                                                              ', ' num2str(this.results.ANOVA_ER.interferenceEffect.stats{7,3}) ...    
                                                              ') = ' num2str(this.results.ANOVA_ER.interferenceEffect.stats{4,end-1}) ...
                                                              ', p = ' num2str(this.results.ANOVA_ER.interferenceEffect.stats{4,end})]);
                                                          
            disp('---');
            
            disp(['RT ANOVA (2x2, Facilitation Effect), reward, F(' num2str(this.results.ANOVA_RT.facilitationEffect.stats{2,3}) ... % df for interaction = df(condition 1) * df(condition 2)
                                                              ', ' num2str(this.results.ANOVA_RT.facilitationEffect.stats{5,3}) ...    
                                                              ') = ' num2str(this.results.ANOVA_RT.facilitationEffect.stats{2,end-1}) ...
                                                              ', p = ' num2str(this.results.ANOVA_RT.facilitationEffect.stats{2,end})]);
                                                          
            disp(['RT ANOVA (2x2, Facilitation Effect), congruency, F(' num2str(this.results.ANOVA_RT.facilitationEffect.stats{3,3}) ... 
                                                              ', ' num2str(this.results.ANOVA_RT.facilitationEffect.stats{6,3}) ...    
                                                              ') = ' num2str(this.results.ANOVA_RT.facilitationEffect.stats{3,end-1}) ...
                                                              ', p = ' num2str(this.results.ANOVA_RT.facilitationEffect.stats{3,end})]);
                                                          
            disp(['RT ANOVA (2x2, Facilitation Effect), reward x congruency, F(' num2str(this.results.ANOVA_RT.facilitationEffect.stats{4,3}) ... 
                                                              ', ' num2str(this.results.ANOVA_RT.facilitationEffect.stats{7,3}) ...    
                                                              ') = ' num2str(this.results.ANOVA_RT.facilitationEffect.stats{4,end-1}) ...
                                                              ', p = ' num2str(this.results.ANOVA_RT.facilitationEffect.stats{4,end})]);
                                                          
            disp(['ER ANOVA (2x2, Facilitation Effect), reward, F(' num2str(this.results.ANOVA_ER.facilitationEffect.stats{2,3}) ... 
                                                              ', ' num2str(this.results.ANOVA_ER.facilitationEffect.stats{5,3}) ...    
                                                              ') = ' num2str(this.results.ANOVA_ER.facilitationEffect.stats{2,end-1}) ...
                                                              ', p = ' num2str(this.results.ANOVA_ER.facilitationEffect.stats{2,end})]);
                                                          
            disp(['ER ANOVA (2x2, Facilitation Effect), congruency, F(' num2str(this.results.ANOVA_ER.facilitationEffect.stats{3,3}) ... 
                                                              ', ' num2str(this.results.ANOVA_ER.facilitationEffect.stats{6,3}) ...    
                                                              ') = ' num2str(this.results.ANOVA_ER.facilitationEffect.stats{3,end-1}) ...
                                                              ', p = ' num2str(this.results.ANOVA_ER.facilitationEffect.stats{3,end})]);
                                                          
            disp(['ER ANOVA (2x2, Facilitation Effect), reward x congruency, F(' num2str(this.results.ANOVA_ER.facilitationEffect.stats{4,3}) ... 
                                                              ', ' num2str(this.results.ANOVA_ER.facilitationEffect.stats{7,3}) ...    
                                                              ') = ' num2str(this.results.ANOVA_ER.facilitationEffect.stats{4,end-1}) ...
                                                              ', p = ' num2str(this.results.ANOVA_ER.facilitationEffect.stats{4,end})]);
