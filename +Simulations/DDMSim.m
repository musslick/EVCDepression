classdef DDMSim < Simulations.Simulation
    ...
    properties
        ...
        defaultRandomProcess                         % default random DDM process
        ...
        defaultRandomProxy                           % default DDM parameter that reflects within subject noise
        ...
        defaultRandomFnc                             % default function that maps random bias to DDM parameter
    ...
    methods
        ...
        function this = DDMSim()
            ...
            this.defaultDDMParams.T0 = 0.2;                                                 % Non-decision time (sec)
            ...
            temp.defaultAutomaticFnc.params{1} = [];
            this.defaultAutomaticFnc = DDMFnc(temp.defaultAutomaticFnc.type, temp.defaultAutomaticFnc.params);
            
            temp.defaultRandomFnc.type = DDMFnc.RANDUNIFORM;                              % noise-to-DDM function type
            temp.defaultRandomFnc.params{1} = [0.4; 0.6];                                % function parameter: lower and upper bound of output DDM parameter range
            this.defaultRandomFnc = DDMFnc(temp.defaultRandomFnc.type, ...
                                               temp.defaultRandomFnc.params);
            ...
            this.defaultRandomProcess = DDMProc(DDMProc.ACTUAL_EXPECTED, ...        % default random DDM process
                                                    DDMProc.BIAS, ...
                                                    this.defaultRandomFnc);                                                
