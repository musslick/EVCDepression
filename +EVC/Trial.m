classdef Trial < handle
    ...
    properties
        ...
        cueOutcomeValues;     % flag if reward is cued
    ...
    methods
        ...
        function this = Trial(varargin)
            ...
            if(length(varargin) == 1)
                ...
                if(isfield(varargin{1}, 'cueOutcomeValues') || isprop(varargin{1}, 'cueOutcomeValues'))
                    this.cueOutcomeValues = varargin{1}.cueOutcomeValues;
                else
                    this.cueOutcomeValues = 0;
                end
