function [meanERs,meanRTs,meanDTs,condRTs,condVarRTs, condSkewRTs, allRRs,scaledX0] = AS_ddmSimFRG_Mat(RVs,P,ddmPars,sepCDFs, flipChoiceProb,actualChoices,numNDDMsims)
